...
export let scheduleData: Object[] = [
    {
        ...
        StartTime: new Date(2018, 1, 13, 12, 30),
        ...
        StartTime: new Date(2018, 1, 9, 10, 30),
        EndTime: new Date(2018, 1, 9, 12, 30),
        CategoryColor: '#1aaa55'
    }, {
        Id: 14,
        ...
        EndTime: new Date(2018, 1, 12, 9, 30),
        CategoryColor: '#00bdae'
    }, {
        Id: 18,
        ...
        EndTime: new Date(2018, 1, 15, 9, 30),
        CategoryColor: '#7fa900'
    }, {
        Id: 20,
        Subject: 'Sky Gazers',
...
export let resourceData: Object[] = [
    {
        ...
        StartTime: new Date(2018, 3, 12, 13, 0),
        EndTime: new Date(2018, 3, 12, 15, 15),
        IsAllDay: false,
        OwnerId: 1,
        RoomId: 1
    }, {
        ...
        Id: 17,
        Subject: 'Quality Analysis',
        StartTime: new Date(2018, 3, 12, 12),
        EndTime: new Date(2018, 3, 12, 15, 30),
        IsAllDay: false,
        OwnerId: 1,
        RoomId: 1
    }, {
        Id: 18,
        Subject: 'Debugging',
        StartTime: new Date(2018, 3, 12, 9, 0),
        EndTime: new Date(2018, 3, 12, 11, 15),
        IsAllDay: false,
        OwnerId: 2,
        RoomId: 2
    }, {
        ...
        Id: 25,
        Subject: 'Timeline estimation',
        StartTime: new Date(2018, 3, 13, 12),
...
export let roomData: Object[] = [
    ...
    },
    {
        ...
        Subject: 'Board Meeting',
        Description: 'Meeting to discuss business plans.',
        StartTime: new Date(2018, 9, 1, 16, 30),
        EndTime: new Date(2018, 9, 1, 18, 0),
        RoomId: 10
    },
    {
        Id: 25,
...

    {
        ...
        EndTime: new Date(2018, 9, 1, 11, 0),
        RoomId: 1
    },
    {
        Id: 29,
        Subject: 'Training session on JSP',
        Description: 'Knowledge sharing on JSP topics.',
        StartTime: new Date(2018, 9, 1, 17, 0),
        EndTime: new Date(2018, 9, 1, 20, 0),
        RoomId: 6
    },
    {
        Id: 30,
        Subject: 'Sprint Planning with Team members',
        Description: 'Planning tasks for sprint.',
        StartTime: new Date(2018, 9, 1, 10, 30),
        EndTime: new Date(2018, 9, 1, 12, 0),
        RoomId: 2
    },
    {
        Id: 31,
    ...
    },
    {
        ...
        Subject: 'Training session on C#',
        Description: 'Training session',
        StartTime: new Date(2018, 9, 1, 14, 30),
        EndTime: new Date(2018, 9, 1, 16, 0),
        RoomId: 2
    },
    {
        Id: 34,
        ...
        Description: 'Meeting to discuss client requirements.',
        StartTime: new Date(2018, 9, 1, 10, 30),
        EndTime: new Date(2018, 9, 1, 13, 0),
        RoomId: 3
    },
    {
        Id: 35,
        Subject: 'Appraisal Meeting',
        Description: 'Meeting to discuss employee appraisals.',
        StartTime: new Date(2018, 9, 1, 15, 0),
        EndTime: new Date(2018, 9, 1, 16, 30),
        RoomId: 8
    },
    {
        Id: 36,
        Subject: 'HR Meeting',
        Description: 'Meeting to discuss HR plans.',
        StartTime: new Date(2018, 9, 1, 9, 30),
        EndTime: new Date(2018, 9, 1, 11, 30),
        RoomId: 4
    },
    {
        Id: 37,
        Subject: 'Customer Meeting',
        Description: 'Meeting to discuss customer reported issues.',
        StartTime: new Date(2018, 9, 1, 10, 0),
        EndTime: new Date(2018, 9, 1, 12, 0),
        RoomId: 9
    },
    {
        ...
        Description: 'Meeting to discuss business plans.',
        StartTime: new Date(2018, 9, 1, 15, 0),
        EndTime: new Date(2018, 9, 1, 17, 0),
        RoomId: 4
    },
    {
        Id: 39,
        ...
        Description: 'Knowledge sharing on Vue concepts.',
        StartTime: new Date(2018, 9, 1, 9, 0),
        EndTime: new Date(2018, 9, 1, 10, 30),
        RoomId: 5
    },
    {
        Id: 40,
        Subject: 'Meeting with Team members',
        Description: 'Meeting to discuss on work report.',
        StartTime: new Date(2018, 9, 1, 11, 30),
        EndTime: new Date(2018, 9, 1, 12, 30),
        RoomId: 5
    },
    {
        Id: 41,
        Subject: 'Meeting with General Manager',
        Description: 'Meeting to discuss support plan.',
        StartTime: new Date(2018, 9, 1, 14, 0),
        EndTime: new Date(2018, 9, 1, 16, 0),
        RoomId: 10
    },
    {
        ...
        Subject: 'HR Meeting',
        Description: 'Meeting to discuss HR plans.',
        StartTime: new Date(2018, 9, 1, 18, 0),
        EndTime: new Date(2018, 9, 1, 20, 0),
        RoomId: 2
    },
    {
        ...
        Subject: 'HR Meeting',
        Description: 'Meeting to discuss HR plans.',
        StartTime: new Date(2018, 9, 1, 17, 30),
        EndTime: new Date(2018, 9, 1, 20, 0),
        RoomId: 1
    },
    {
    ...
    },
    {
        ...
        Subject: 'Board Meeting',
        Description: 'Meeting to discuss business plans.',
        StartTime: new Date(2018, 9, 1, 18, 30),
        EndTime: new Date(2018, 9, 1, 20, 0),
        RoomId: 4
    },
    {
        ...
        Subject: 'Board Meeting',
        Description: 'Meeting to discuss business plans.',
        StartTime: new Date(2018, 9, 1, 15, 30),
        EndTime: new Date(2018, 9, 1, 18, 0),
        RoomId: 5
    },
    {
    ...
    },
    {
        ...
        Description: 'Meeting to discuss employee appraisals.',
        StartTime: new Date(2018, 9, 1, 18, 0),
        EndTime: new Date(2018, 9, 1, 19, 30),
        RoomId: 7
    },
    {
        Id: 53,
    ...
    },
    {
        ...
        Subject: 'Support Meeting with Managers',
        Description: 'Meeting to discuss support plan.',
        StartTime: new Date(2018, 9, 1, 11, 0),
        EndTime: new Date(2018, 9, 1, 12, 30),
        RoomId: 8
    },
    {
...
export let schedulerData: Object[] = [
    {
        Id: 1,
        Subject: 'Explosion of Betelgeuse Star',
        StartTime: new Date(2023, 12, 11, 9, 30),
        EndTime: new Date(2023, 12, 11, 11, 0),
        CategoryColor: '#1aaa55'
    }, {
        Id: 2,
        Subject: 'Thule Air Crash Report',
        StartTime: new Date(2023, 12, 12, 12, 0),
        EndTime: new Date(2023, 12, 12, 14, 0),
        CategoryColor: '#357cd2'
    }, {
        Id: 3,
        Subject: 'Blue Moon Eclipse',
        StartTime: new Date(2023, 12, 13, 12, 30),
        EndTime: new Date(2023, 12, 13, 11, 0),
        CategoryColor: '#7fa900'
    }, {
        Id: 4,
        Subject: 'Meteor Showers in 2018',
        StartTime: new Date(2023, 12, 14, 13, 0),
        EndTime: new Date(2023, 12, 14, 14, 30),
        CategoryColor: '#ea7a57'
    }, {
        Id: 5,
        Subject: 'Milky Way as Melting pot',
        StartTime: new Date(2023, 12, 15, 12, 0),
        EndTime: new Date(2023, 12, 15, 14, 0),
        CategoryColor: '#00bdae'
    }, {
        Id: 6,
        Subject: 'Mysteries of Bermuda Triangle',
        ...
        Id: 9,
        Subject: 'Glaciers and Snowflakes',
        StartTime: new Date(2023, 12, 16, 11, 0),
        EndTime: new Date(2023, 12, 16, 12, 30),
        CategoryColor: '#1aaa55'
    }, {
        Id: 8,
        Subject: 'Life on Mars',
        StartTime: new Date(2023, 12, 17, 9, 0),
        EndTime: new Date(2023, 12, 17, 10, 0),
        CategoryColor: '#357cd2'
    }, {
        Id: 9,
        Subject: 'Alien Civilization',
        StartTime: new Date(2023, 12, 19, 11, 0),
        EndTime: new Date(2023, 12, 19, 13, 0),
        CategoryColor: '#7fa900'
    }, {
        Id: 10,
        Subject: 'Wildlife Galleries',
        StartTime: new Date(2023, 12, 21, 11, 0),
        EndTime: new Date(2023, 12, 21, 13, 0),
        CategoryColor: '#ea7a57'
    }, {
        Id: 11,
        Subject: 'Best Photography 2018',
        StartTime: new Date(2023, 12, 22, 9, 30),
        EndTime: new Date(2023, 12, 22, 11, 0),
        CategoryColor: '#00bdae'
    }, {
        Id: 12,
        Subject: 'Smarter Puppies',
        StartTime: new Date(2023, 12, 9, 10, 0),
        EndTime: new Date(2023, 12, 9, 11, 30),
        CategoryColor: '#f57f17'
    }, {
        Id: 13,
        Subject: 'Myths of Andromeda Galaxy',
        StartTime: new Date(2023, 12, 9, 10, 30),
        ...
        EndTime: new Date(2023, 12, 5, 11, 30),
        CategoryColor: '#357cd2',
        GroupId: 1
    }, {
        Id: 15,
        Subject: 'Facts of Humming Birds',
        StartTime: new Date(2023, 12, 20, 9, 30),
        EndTime: new Date(2023, 12, 20, 11, 0),
        CategoryColor: '#7fa900',
        GroupId: 1
    }, {
        Id: 16,
        Subject: 'Sky Gazers',
        StartTime: new Date(2023, 12, 23, 11, 0),
        EndTime: new Date(2023, 12, 23, 13, 0),
        CategoryColor: '#ea7a57',
        GroupId: 1
    }, {
        Id: 17,
        Subject: 'The Cycle of Seasons',
        StartTime: new Date(2023, 12, 12, 5, 30),
        EndTime: new Date(2023, 12, 12, 9, 30),
        CategoryColor: '#00bdae',
        GroupId: 1
    }, {
        Id: 18,
        Subject: 'Space Galaxies and Planets',
        StartTime: new Date(2023, 12, 12, 17, 0),
        EndTime: new Date(2023, 12, 12, 18, 30),
        CategoryColor: '#f57f17',
        GroupId: 1
    }, {
        Id: 19,
        Subject: 'Lifecycle of Bumblebee',
        StartTime: new Date(2023, 12, 15, 6, 0),
        EndTime: new Date(2023, 12, 15, 9, 30),
        CategoryColor: '#7fa900',
        GroupId: 1
    }, {
        Id: 20,
        Subject: 'Sky Gazers',
        StartTime: new Date(2023, 12, 15, 16, 0),
        EndTime: new Date(2023, 12, 15, 18, 0),
        CategoryColor: '#ea7a57',
        GroupId: 1
    }
];
...
export function generateObject() {
    ...
    for (var a = 0; a < 25; a++) {
      data.push({
        Id: a + 1,
        Subject: 'Testing',
        StartTime: new Date(2023, 3, 28),
        EndTime: new Date(2023, 3, 29),
        IsAllDay: true
      });
    }
    return data;
